...
void Shutdown()
{
    ...
    RenameThread("dogeseedz-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/DogeCoinGold1/DogeSeedz>";
    const std::string URL_WEBSITE = "<https://dogeseedz.net>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("dogeseedz-loadblk");
