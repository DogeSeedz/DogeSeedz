...
const char * const BITCOIN_CONF_FILENAME = "dogeseedz.conf";
const char * const BITCOIN_PID_FILENAME = "dogeseedzd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dogeseedz";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dogeseedz";
#else
    // Unix
    return pathRet / ".dogeseedz";
#endif
#endif
}
